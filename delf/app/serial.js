        ...
        SerialPort.list().then(listSerialDevices => {
            ...
            parser.on('data', (data) => {
                ...
                if(value.length > 1){
                    ...
                    // let lux = parseFloat(value[2].replace('\r',''));
                    // let temp2 = parseFloat(value[3].replace('\r',''));
                    let chave = parseFloat(value[4] && value[4].replace('\r',''));
    
                    // this.listData.push(humidity);
                    // this.__listDataTemp.push(temperature);
                    // this.ListSwitch.push(lux);
                    // this.ListLux.push(temp2)
                    this.listDataChave.push(chave)
    
                    // console.log("Temp: ",temperature," Umidade: ",humidity, 'Luz: ',lux,'Temp2: ',temp2, 'chave', chave);
...
module.exports.ArduinoData = {List: serial.List, 
                              ...
                              ListChave: serial.listDataChave
                            } 